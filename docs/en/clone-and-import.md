...
`git clone https://github.com/ByteLegendQuest/java-print-array-in-spiral-form`

A project directory named `java-print-array-in-spiral-form` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-print-array-in-spiral-form` directory which is created just now.
